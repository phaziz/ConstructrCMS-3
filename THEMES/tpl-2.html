...
<body>
	...
	<div class="row mt100 mb100 center">
		<div class="col s12">
    		<img src="{{@ CONSTRUCTR_BASE_URL @}}/THEMES/ASSETS/phaziz.png" alt="ConstructrCMS | phaziz.com">
		</div>
	</div>

	<div class="row mt100 mb100 center">
		<div class="col s12">
    		{{@ CONSTRUCTR_MAPPING(big_center_heading) @}}
		</div>
	</div>

	<div class="row mt100 mb100 center">
		<div class="col s12">
    		{{@ CONSTRUCTR_MAPPING(big_center_subheading) @}}
		</div>
	</div>

	<div class="row mt100 mb100 btop">
