...
$APP->route('GET  /constructr/no-login [sync]','ConstructrBase->no_login');
...
$APP->route('GET  /constructr/uploads/delete/@offset/@file [sync]','ConstructrUploads->uploads_delete_file');
$APP->route('GET  /constructr/uploads/edit/@offset/@file [sync]','ConstructrUploads->uploads_edit_file');
...
$APP->route('GET  /constructr/content/@page_id/new-after/@content_id [sync]','ConstructrContent->content_new_after');
$APP->route('POST /constructr/content/@page_id/new-after [sync]','ConstructrContent->content_new_after_verify');
$APP->route('GET  /constructr/content/@page_id/new-before/@content_id [sync]','ConstructrContent->content_new_before');
$APP->route('POST /constructr/content/@page_id/new-before [sync]','ConstructrContent->content_new_before_verify');
